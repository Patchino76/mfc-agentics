...
initial_state = AgentState(
    messages=[
        ...
        Always use the provided tools to accomplish the task. You will recieve a generated code from a
        function and you need to choose the appropriate tool for execution of the code."""),
